...
def diagonal_r(matrix):
    ...
    for x in range(len(matrix)-3):
        for y in range(len(matrix)-3):
            product1 =  matrix[x][y]*matrix[x+1][y+1]*matrix[x+2][y+2]*matrix[x+3][y+3] # Diagonal right
            lista1.append(product1)
    return lista1
...
def horizontal(matrix):
    ...
    for x in range(len(matrix)):
        for y in range(len(matrix)-3):
            product2 =  matrix[x][y]*matrix[x][y+1]*matrix[x][y+2]*matrix[x][y+3] # Horizontal
            lista2.append(product2)
    return lista2
...
def vertical(matrix):
    ...
    for x in range(len(matrix)-3):
        for y in range(len(matrix)):
            product3 =  matrix[x][y]*matrix[x+1][y]*matrix[x+2][y]*matrix[x+3][y] # Vertical
            lista3.append(product3)
    return lista3
...
def main():
    ...
    lista = diagonal_l(matrix) + diagonal_r(matrix) + horizontal(matrix) + vertical(matrix)

    # Taking the max value from list
    max_value = max(lista)
    print(lista)

    # Printing de max value
    print(max_value)
